...
class DecisionTreeC45(object):
    """
     Khởi tạo cây với các ràng buộc cho điều kiện dừng gồm max_depth, min_samples_split,min_gain_ratio
        ngoài ra còn có các thông tin sau:
        
        Root        Gốc của cây
        Ntrain      Số lượng dữ liệu huấn luyện
    """
    def __init__(self, max_depth= 3, min_samples_split = 2, min_gain = 1e-4):
        self.root = None
    ...
    def _split(self, node):
        ...
        Trong này, gồm có tính gain ratio cũng như tìm thuộc tính tốt nhất để phát triển tại node này 
        """
        ids = node.ids
        best_gain = 0
        best_splits = []
        ...
        for i, att in enumerate(self.attributes):
            ...
            for split in splits:
                ...
                PxS -= len(split)/len(ids)*math.log(len(split)/len(ids),2)
...
if __name__ == "__main__":
    ...
    tree = DecisionTreeC45(max_depth = 3, min_samples_split = 2)
